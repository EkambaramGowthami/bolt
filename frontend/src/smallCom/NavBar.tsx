...
export const NavBar = ({setApp}:any) => {
  ...
  return <div className="relative top-6 left-0 w-full overflow-x-auto pb-4">
      <nav className="flex flex-nowrap items-center justify-between text-white px-4 py-3 min-w-max">
        
        <div className="flex md:text-2xl font-medium shrink-0">
